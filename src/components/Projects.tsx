...
import leitoCabo8 from "@/assets/leito-cabo-8.jpg"; // Nova imagem adicionada
...
const Projects = () => {
  const projects = [
    ...
    {
      image: leitoCabo2,
      images: [leitoCabo2, leitoCabo3, leitoCabo4, leitoCabo5, leitoCabo6, leitoCabo7, leitoCabo8], // Lista de imagens atualizada
