...
import leitoCabo9 from "@/assets/leito-cabo-9.jpg"; // Nova imagem adicionada
...
const Projects = () => {
  const projects = [
    ...
    {
      image: leitoCabo2,
      images: [leitoCabo2, leitoCabo3, leitoCabo4, leitoCabo5, leitoCabo6, leitoCabo7, leitoCabo8, leitoCabo9], // Lista de imagens atualizada
